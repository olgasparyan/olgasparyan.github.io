...
\item[] \textit{Dissertation Title}: ``Decentralization and local development in non-democratic political systems”
\item [] \textit{Dissertation committee:} Randall Stone (chair), Gretchen Helmke, Alexander Lee, Anderson Frey 
\item[] \textit{Defense chair: }Matthew Lenoe (Department of History)
\item[] \textit{Outside Reader:} Travis Baseler (Department of Economics)
...
Decentralization, local politics, local efficiency, public goods provision,  institutions in autocracies, political economy of development, historical legacy, causal inference, deep learning, image-as-data
...
APSA 2018, 2019, 2020; MPSA 2014, 2015, 2018, 2019, 2020 (canceled), 2021
  \vspace*{-4.5mm} 

2021: Wisconsin Russia Project Young Scholars Conference, ICSID Annual Conference, Higher School of Economics, Women in Political Methodology Speaker Series (scheduled)
...
Organizer and Coordinator, Data Science Summer School, Hertie School and SCRIPTS, 2021
\vspace*{-4.5mm}
