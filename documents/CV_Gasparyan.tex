...
\usepackage[left=0.9in, right=1in, bottom=0.8in, top=0.8in]{geometry}
\usepackage[utf8]{inputenc}
...
(585)\textendash434\textendash8854 $\bullet$  \href{mailto:ogaspary@ur.rochester.edu}{ogaspary@ur.rochester.edu} $\bullet$ \href{www.olgasparyan.com}{www.olgasparyan.com}
\\
...
& \textit{Politics Newsletter}, Fall 2019, XXIX(2) 5-11.\\
& \\
&\\
\Large{Working}
