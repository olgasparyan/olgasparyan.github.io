...
{``The 2022 Europe Report of the Lancet Countdown on Health and Climate Change: towards a climate resilient future''} (with Kim R. van Daalen et al.) (accepted at \textit{Lancet Public Health})

\vspace*{-2.5mm}
\href{https://www.dropbox.com/s/eabsdevozqwpdzg/SeparationProject.pdf?dl=0}{``Finding and Accounting for Separation Bias in Strategic Choice Models''} (with Casey Crisman-Cox, Curtis Signorino) (conditionally accepted at \textit{Political Analysis})
...
\href{https://olgasparyan.com/documents/IndRule_paper.pdf}{``Indirect Rule and Public Goods Provision: Evidence from Colonial India''} (under review)

\vspace*{-2.5mm}

``The Supply and Demand of Visual Media Bias: The Production and Interpretation of News Content'' (with Elena Sirotkina and Michelle Torres)
...
APSA 2018-2020, 2022 (scheduled); MPSA 2014, 2015, 2018-2022, 2020 (canceled); EPSA 2021, 2022; ASEEES 2021, ISA 2022, PolMeth 2022
  \vspace*{-4.5mm} 

2022: University of Bremen Economic Colloquium, PolMeth-Europe (Hamburg)
\\
...
English (fluent), German (intermediate), Spanish (pre-intermediate), French (beginner),  Russian (native)
\vspace*{-4.5mm}
