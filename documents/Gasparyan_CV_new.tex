...
\href{https://www.dropbox.com/s/r5rlqzad91zkna6/IndirectRule_PublicGoods_nov19_forwebsite.pdf?dl=0}{``Indirect Rule and Public Goods Provision: Evidence from Colonial  India''}
\begin{list1}
    \item[] (Under Review)
\end{list1}
...
Graduate Student Fellowship, University of Rochester, 2015\textendash present
\vspace*{-4.5mm}

Carnegie/Harriman Research Grant, Columbia University, January 2020 
\vspace*{-4.5mm}
